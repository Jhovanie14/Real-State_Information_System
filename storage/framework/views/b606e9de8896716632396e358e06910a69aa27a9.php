                        ...
                        <div class="card-body">
                            <div class="d-md-flex justify-content-between">
                                ...
                                <div class="d-flex flex-md-column align-items-center py-3" style="width: 20%;">
                                    <a href="/properties/<?php echo e($property->id); ?>" class="btn btn-block btn-primary">
                            ...
                            <div class="d-md-flex">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="d-lg-flex justify-content-start">
                                        <div class="col-lg-12">
                                            <a href="/brokers/<?php echo e($property->client->agent->broker->id); ?>" class="text-dark">
                                                <div class="card border border-gray shadow h-100 my-auto">
                                                    <div class="card-body">
                                                        <div class="d-flex justify-content-start">
                                                            <div class="mr-4 my-auto align-items-center">
...
<?php $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade" id="confirmArchive<?php echo e($property->ppt_id); ?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="/properties/<?php echo e($property->ppt_id); ?>/archive" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="confirmDelete<?php echo e($property->ppt_id); ?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="/properties/<?php echo e($property->ppt_id); ?>/delete" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
...
<div class="modal fade" id="confirmActivate<?php echo e($property->ppt_id); ?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-warning">
            ...
            <div class="modal-footer">
                <form action="/properties/<?php echo e($property->ppt_id); ?>/activate" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
...
<?php echo $__env->make('layouts.themes.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Infinit\maria-homes\resources\views/admin/properties/index.blade.php ENDPATH**/ ?>