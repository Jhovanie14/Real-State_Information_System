                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 px-3">
                                                ...
                                                <div class="col-12 mb-2 d-flex flex-column">
                                                    <span class="display-4 text-bold">&#8369; <?php echo e(number_format($property->total_balance, 2) ?? '0'); ?></span>
                                                ...
                                                <div class="col-12 d-flex flex-column">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="px-2 py-1 h5 rounded bg-success">
                                                            <?php echo e(\Carbon\Carbon::parse($property->payments()->latest()->first()->next_payment)->format('F
                                                            d, Y')); ?>
                                                ...
                                                <div class="d-md-flex justify-content-between align-items-end mt-2">
                                                    <div class="col-md-3 mt-2">
                                                        ...
                                                        <input type="text" disabled name="equityFee"
                                                            ...
                                                            value="<?php echo e($property->equity_fee ?? ''); ?>">
                                                    </div>
                                                    <div class="col-md-3 mt-2">
                                                ...
                                                <div class="d-md-flex justify-content-between align-items-end mt-2">
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <input type="text" disabled name="loanableAmount"
                                                            class="form-control text-lg"
                                                            value="<?php echo e($property->loanable_amount ?? '00.00'); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-lg-flex justify-content-start">
                                                    <div class="col-lg-12">
                                                        <a href="/brokers/<?php echo e($property->client->broker->id); ?>"
                                                            class="text-dark">
                                                            <div class="card border border-gray shadow h-100 my-auto">
                                                                <div class="card-body">
                                                                    <div class="d-flex justify-content-start">
                                                                        <div class="mr-4 my-auto align-items-center">
                                                                            <img src="<?php echo e($property->client->broker->image ? asset('/storage/'. $property->client->broker->image) : asset('images/default.png')); ?>"
                                                                                class="roundedExtraSmallImage mx-auto"
                                                                                alt="">
                                                                        </div>
                                                                        <div class="d-flex-column">
                                                                            <div class="h4 mb-0">
                                                                                <?php echo e($property->client->broker->name); ?>

                                                                            </div>
                                                                            <div class="h6 mb-0">
                                                                                <?php echo e($property->client->broker->email); ?>

                                                                            </div>
                                                                            <div class="h6">
                                                                                <?php echo e($property->client->broker->contact_no); ?>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-bordered table-lg ">
                                                        ...
                                                        <tbody>
                                                            <?php $__currentLoopData = $property->paymentSchedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr class="text-bold">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-bordered table-lg">
                                                        ...
                                                        <tbody>
                                                            <?php $__currentLoopData = $property->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr class="text-bold">
                                                                <td class="text-bold h6 text-center">
                                                                    <?php echo e($loop->iteration); ?>
                                                                ...
                                                                <td class=" text-right h6">
                                                                    <?php echo e(Carbon\Carbon::parse($payment->created_at)->format('F
                                                                    d, Y')
                                                                    ?? ''); ?>
...
<div class="modal fade" id="addPaymentModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <form action="/properties/<?php echo e($property->id); ?>/payment" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.themes.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Infinit\maria-homes\resources\views/admin/properties/show.blade.php ENDPATH**/ ?>