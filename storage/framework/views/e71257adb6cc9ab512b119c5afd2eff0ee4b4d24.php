            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form action="/properties/in-house/<?php echo e($property->id); ?>/cancel" method="POST">
                            <?php echo csrf_field(); ?>
        ...
        <div class="modal fade" id="confirmDelete<?php echo e($property->id); ?>" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form action="/properties/in-house/<?php echo e($property->id); ?>/delete" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PATCH'); ?>
        ...
        <div class="modal fade" id="confirmRestore<?php echo e($property->id); ?>" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form action="/properties/in-house/<?php echo e($property->id); ?>/restore" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PATCH'); ?>
...
<?php echo $__env->make('layouts.themes.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Infinit\maria-homes\resources\views/admin/properties/in-house/index.blade.php ENDPATH**/ ?>