                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="d-flex flex-column justify-content-center align-items-center"
                                    style="width: 15%;">
                                    <a href="/agents/<?php echo e($agent->id); ?>" class="btn btn-block btn-primary btn-block">
                                    ...
                                    <?php if($agent->active == 1): ?>
                                    <a href="#" data-toggle="modal" data-target="#confirmDelete<?php echo e($agent->id); ?>"
                                        class="btn btn-block btn-danger">
                                        <i class="fa-solid fa-trash"></i>
                                        <span class="d-none d-md-inline">&nbsp;Delete</span>
                                    </a>
                                    <?php else: ?>
                                    <a class="btn btn-block btn-dark disabled">
                                        <i class="fa-solid fa-trash"></i>
                                        <span class="d-none d-md-inline">&nbsp;Delete</span>
                                    </a>
                                    <?php endif; ?>
...
<div class="modal fade" id="confirmDelete<?php echo e($agent->id); ?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="/brokers/<?php echo e($agent->id); ?>/delete" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="confirmArchive<?php echo e($agent->id); ?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="/brokers/<?php echo e($agent->id); ?>/archive" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
...
<div class="modal fade" id="confirmUnarchive<?php echo e($agent->id); ?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="/brokers/<?php echo e($agent->id); ?>/activate" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
...
<?php echo $__env->make('layouts.themes.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Infinit\maria-homes\resources\views/admin/agents/index.blade.php ENDPATH**/ ?>