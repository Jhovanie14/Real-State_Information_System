            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex align-items-center">
                        ...
                        <a class="btn btn-primary ml-3" target="_blank" href="/reservations/hdmf-loan/<?php echo e($reservation->id); ?>/print">
                                        ...
                                        <div class="col-md-5 px-3">
                                            <div class="d-flex-column">
                                                ...
                                                <div class="text-center mt-1">
                                                    ...
                                                    <?php if($reservation->reservation == -1): ?>
                                                        <div class="my-2">
                                                            <span class="px-2 h5 rounded bg-danger">
                                                                RESERVATION DELETED
                                                            </span>
                                                        </div>
                                                    <?php elseif($reservation->reservation == 0): ?>
                                                        <div class="my-2">
                                                            <span class="px-2 h5 rounded bg-warning">
                                                                RESERVATION CANCELLED
                                                            </span>
                                                        </div>
                                                    <?php elseif($reservation->reservation == 2): ?>
                                                        <div class="my-2">
                                        ...
                                        <div class="col-md-7 px-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <?php if($reservation->reservation == 2): ?>
                                                        <a href="/properties/hdmf-loan/<?php echo e($reservation->id); ?>"
                                                            class="btn btn-success ml-3">
                                                            <i class="fa-solid fa-eye"> </i>
                                                            <span class="d-none d-md-inline-block">&nbsp;View
                                                                Property</span>
                                                        </a>
                                                    <?php elseif($reservation->reservation == 1): ?>
                                            ...
                                            <div class="d-flex justify-content-between align-items-start mt-1 mb-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <div>
                                                        <label class="control-label  text-lg">Equity
                                                            Term:&nbsp;</label>
                                                        <span class="px-2 py-1 h5 rounded bg-primary">
                                                            <?php if($reservation->equity_term == 1): ?>
                                                                Spot Cash
                                                            <?php else: ?>
                                                                <?php echo e($reservation->equity_term ?? ''); ?> Months
                                                            <?php endif; ?>
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-md-flex justify-content-between align-items-end mt-2">
                                                ...
                                                <?php if($reservation->loanable_amount): ?>
                                                    <div class="col-md-12 mt-2">
                                                        <label for="loanableAmount" class="control-label text-lg">HDMF/Bank
                                                            Loanable
                                                            Amount:</label>
                                                        <input type="text" disabled name="loanableAmount"
                                                            class="form-control form-control-lg text-lg"
                                                            value="&#8369; <?php echo e(number_format($reservation->loanable_amount, 2) ?? ''); ?>">
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                            <div class="d-md-flex justify-content-between align-items-end mt-2">
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    ...
                                                    <input type="text" disabled name="processingFee"
                                                        class="form-control form-control-lg text-lg"
                                                        value="&#8369; <?php echo e(number_format($reservation->equity_total, 2) ?? ''); ?>">
                                                </div>
                                                <div class="col-md-6 mt-2">
                                                    ...
                                                    <input type="text" disabled name="cornerLotFee"
                                                        class="form-control form-control-lg text-lg"
                                                        value="&#8369; <?php echo e(number_format($reservation->equity_total / $reservation->equity_term, 2) ?? ''); ?>">
                                                </div>
                                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="h5">
                        Are you sure you want to proceed to the equity scheme?
                    </div>
                </div>
                <div class="modal-footer">
                    <form action="/reservations/hdmf-loan/<?php echo e($reservation->id); ?>/finish" method="POST">
                        <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="cancelReservation" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/reservations/hdmf-loan/<?php echo e($reservation->id); ?>/cancel" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PATCH'); ?>
    ...
    <div class="modal fade" id="restoreReservation" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/reservations/hdmf-loan/<?php echo e($reservation->id); ?>/restore" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PATCH'); ?>
    ...
    <div class="modal fade" id="deleteReservation" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/reservations/hdmf-loan/<?php echo e($reservation->id); ?>/delete" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PATCH'); ?>
...
<?php echo $__env->make('layouts.themes.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Infinit\maria-homes\resources\views/admin/reservations/hdmf-loan/show.blade.php ENDPATH**/ ?>