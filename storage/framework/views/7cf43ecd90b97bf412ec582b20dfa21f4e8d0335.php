        ...
        <div class="wrapper">
            <section class="invoice">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <img class="roundedSmallImage border" src="<?php echo e(asset('/storage/icons/mariahomes.png')); ?>"
                        alt="">
                </div>
                        ...
                        <div>
                            ...
                            <p style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Lot
                                    Area&nbsp;&nbsp;
                                    &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                    &nbsp;<?php echo e($reservation->floor_area); ?>m&#178;</span>
                            </p>
                            <p style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Block
                                    No.&nbsp;
                                    &nbsp; &nbsp; &nbsp; &nbsp;:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                    &nbsp;<?php echo e($reservation->blk_no); ?></span>
                            </p>
                            <p style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Lot
                                    No.&nbsp;
                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                    &nbsp;<?php echo e($reservation->lot_no); ?></span>
                            </p>
                            <p style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Title
                                    No.&nbsp;
                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                    &nbsp;<?php echo e($reservation->title_no); ?></span>
                            </p>
                            <p style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                <span style="font-size:16px;">&nbsp;</span>
                            </p>
                            ...
                            <p style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                    ...
                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;:&nbsp; &nbsp; &nbsp; &nbsp;
                                    &nbsp;
                                    &nbsp;<?php echo e($reservation->model); ?></span>
                            </p>
                            <p style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                            ...
                            <p
                                ...
                                <span style="font-size:16px;">Reservation Fee&nbsp; &nbsp; &nbsp; &nbsp;
                                    &nbsp;&nbsp;:
                                    &nbsp;
                                    <strong>&#8369; <?php echo e(number_format($reservation->reservation_fee, 2)); ?></strong>
                                    &nbsp; &nbsp; &nbsp; &nbsp;Holding Date from:&nbsp;
                                    <strong>
                                        <?php echo e(Carbon\Carbon::parse($reservation->created_at)->format('F d, Y')); ?>

                                    </strong>
                                    &nbsp;to:&nbsp;
                                    <strong><?php echo e(Carbon\Carbon::parse($reservation->downpayment_start)->format('F d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                Y')); ?>
                            ...
                            <p
                                ...
                                <span style="font-size:16px;">Contract Price &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                    ...
                                    <strong>Php <?php echo e(number_format($reservation->total_contract_price, 2)); ?>
                            ...
                            <p
                                ...
                                <span style="font-size:16px;">40% Down payment &nbsp; :
                                    <strong>
                                        &#8369; <?php echo e(number_format($reservation->downpayment_total, 2)); ?>

                                    </strong>
                                    &nbsp;Due Date:&nbsp;
                                    <strong>
                                        <?php echo e(Carbon\Carbon::parse($reservation->downpayment_end)->format('F d, Y')); ?>
                            ...
                            <ul style="list-style-type: disc;margin-left:44px;">
                                <?php if($reservation->downpayment_term == 1): ?>
                                    <li><span style="font-size:16px;">Spot Cash
                                            ...
                                            <strong>
                                                Php
                                                <?php echo e(number_format($reservation->downpayment_monthly, 2)); ?>

                                            </strong>)
                                        </span></li>
                                <?php elseif($reservation->downpayment_term == 6): ?>
                                    <li><span style="font-size:16px;">Six (6) months to pay @
                                            <strong>
                                                &#8369;
                                                <?php echo e(number_format($reservation->downpayment_monthly, 2)); ?>/mo.
                                            </strong>
                                            Starting
                                            <strong>
                                                <?php echo e(Carbon\Carbon::parse($reservation->downpayment_start)->format('F d, Y')); ?>
                                ...
                                <?php elseif($reservation->downpayment_term == 12): ?>
                            ...
                            <p style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;60%
                                    Balance &nbsp;:
                                    <strong>
                                        &#8369; <?php echo e(number_format($reservation->balance_total, 2)); ?>

                                    </strong>
                                    &nbsp;Due Date:&nbsp;
                                    <strong>
                                        <?php echo e(Carbon\Carbon::parse($reservation->balance_end)->format('F d, Y')); ?>
                            ...
                            <ul style="list-style-type: disc;margin-left:44px;">
                                <?php if($reservation->balance_term == 1): ?>
                                    <li><span style="font-size:16px;">Spot Cash
                                            ...
                                            <strong>
                                                Php
                                                <?php echo e(number_format($reservation->balance_monthly, 2)); ?>

                                            </strong>)
                                        </span></li>
                                <?php elseif($reservation->balance_term == 6): ?>
                                    <li><span style="font-size:16px;">Six (6) months to pay @
                                            <strong>
                                                &#8369;
                                                <?php echo e(number_format($reservation->balance_monthly, 2)); ?>
                                            ...
                                            Starting
                                            <strong>
                                                <?php echo e(Carbon\Carbon::parse($reservation->balance_start)->format('F d, Y')); ?>
                                ...
                                <?php elseif($reservation->balance_term == 12): ?>
                                ...
                                <?php elseif($reservation->balance_term == 18): ?>
                                ...
                                <?php elseif($reservation->balance_term == 24): ?>
                            ...
                            <p
                                ...
                                <span>
                                    <strong><?php echo e(Carbon\Carbon::parse(Carbon\Carbon::now())->format('F d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                Y')); ?></strong>
                                    Davao City,
                                    Philippines.</span>
                            </p>
...
<?php /**PATH C:\laragon\www\Infinit\maria-homes\resources\views/admin/reservations/in-house/print.blade.php ENDPATH**/ ?>