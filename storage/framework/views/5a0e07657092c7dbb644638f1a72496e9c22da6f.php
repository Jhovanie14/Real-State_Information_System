                        ...
                        <div>
                            ...
                            <p
                                ...
                                <span style="font-size:16px;">Reservation Fee&nbsp; &nbsp; &nbsp; &nbsp;
                                    ...
                                    &nbsp; &nbsp; &nbsp; &nbsp;Holding Date from:&nbsp;
                                    <strong><?php echo e(Carbon\Carbon::parse($reservation->created_at)->format('F d, Y')); ?></strong>
                                    &nbsp;to:&nbsp;
                                    <strong><?php echo e(Carbon\Carbon::parse($reservation->created_at)->addMonth()->format('F d, Y')); ?>
                            ...
                            <p
                                ...
                                <span style="font-size:16px;">Equity &nbsp; :
                                    <strong>
                                        &#8369; <?php echo e(number_format($reservation->equity_total, 2)); ?>

                                    </strong>
                                    &nbsp;Due Date:&nbsp;
                                    <strong>
                                        <?php echo e(Carbon\Carbon::parse($reservation->equity_end)->format('F d, Y')); ?>
                            ...
                            <ul style="list-style-type: disc;margin-left:44px;">
                                <?php if($reservation->equity_term == 1): ?>
                                    <li><span style="font-size:16px;">Spot Cash
                                            ___________________________________________(
                                            <strong>
                                                Php
                                                <?php echo e(number_format($reservation->equity_monthly, 2)); ?>/mo.
                                            </strong>)
                                        </span></li>
                                <?php elseif($reservation->equity_term == 6): ?>
                                    <li><span style="font-size:16px;">Six (6) months to pay @
                                            ...
                                            Starting
                                            <strong>
                                                <?php echo e(Carbon\Carbon::parse($reservation->equity_start)->format('F d, Y')); ?>
                                ...
                                <?php elseif($reservation->equity_term == 12): ?>
                                    <li><span style="font-size:16px;">Twelve (12) months to pay @
                                            <strong>
                                                &#8369;
                                                <?php echo e(number_format($reservation->equity_monthly, 2)); ?>/mo. </strong>
                                            Starting
                                            <strong>
                                ...
                                <?php elseif($reservation->equity_term == 18): ?>
                                ...
                                <?php else: ?>
                                    <li><span style="font-size:16px;">(<?php echo e($reservation->equity_term); ?>) months to pay
                                            @
                                            <strong>
                                                &#8369;
                                                <?php echo e(number_format($reservation->equity_monthly, 2)); ?>/mo.</strong>
...
<?php /**PATH C:\laragon\www\Infinit\maria-homes\resources\views/admin/reservations/hdmf-loan/print.blade.php ENDPATH**/ ?>