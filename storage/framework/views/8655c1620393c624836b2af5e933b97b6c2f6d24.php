                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <?php if($reservation->status == 2): ?>
                                                        <a href="/properties/<?php echo e($reservation->id); ?>"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/reservations/<?php echo e($reservation->id); ?>/finish" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.themes.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Infinit\maria-homes\resources\views/admin/reservations/show.blade.php ENDPATH**/ ?>