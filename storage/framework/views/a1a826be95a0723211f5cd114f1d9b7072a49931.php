                                ...
                                <div class="d-flex-column justify-content-center">
                                    <div class="text-center">
                                        <img class="mb-4 text-center roundedLargeImage" id="clientImagePreview"
                                            src="<?php echo e(asset('/images/default.png')); ?>" alt="Client Image">
                                    </div>
                                    ...
                                    <div class="d-flex-column justify-content-center align-items-center">
                                        <div class="text-center">
                                            <img class="mb-4 text-center roundedLargeImage" id="brokerImagePreview"
                                                src="<?php echo e(asset('/images/default.png')); ?>" alt="Broker Image">
                                        </div>
...
<?php echo $__env->make('layouts.themes.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Infinit\maria-homes\resources\views/admin/clients/create.blade.php ENDPATH**/ ?>