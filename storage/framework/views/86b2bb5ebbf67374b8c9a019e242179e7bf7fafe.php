                ...
                <section class="invoice">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h5 class="display-4" style="font-size: 40px">Maria Homes Development Corporation</h5>
                            <h5 class="h5 pl-1">RESERVATION, EQUITY AND PROCESSING CONTRACT</h5>
                            <h5 class="pl-1"><?php echo e(Carbon\Carbon::now()->format('F d, Y')); ?></h5>
                        </div>
                        <img class="roundedSmallImage border" src="<?php echo e(asset('/storage/icons/mariahomes.png')); ?>" alt="">
                    </div>
                            ...
                            <div>
                                    ...
                                    <ol start="1"
                                        ...
                                        <li
                                            ...
                                            <strong><span style="font-size:16px;">Name of the
                                                ...
                                                <?php echo e($reservation->client->first_name); ?>&nbsp;<?php echo e($reservation->client->middle_name); ?>&nbsp;<?php echo e($reservation->client->last_name); ?>&nbsp;<?php echo e($reservation->client->suffix); ?>
                                ...
                                <p
                                    ...
                                    <span style="font-size:16px;">Address&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp; &nbsp;
                                        &nbsp; &nbsp; &nbsp; &nbsp;:
                                        &nbsp;<?php echo e($reservation->client->present_address); ?></span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;margin-left:36.0pt;text-align:justify;'>
                                    <span style="font-size:16px;">Contact No&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;
                                        &nbsp;
                                        &nbsp; &nbsp;&nbsp;: &nbsp;<?php echo e($reservation->client->contact_no); ?></span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;margin-left:36.0pt;text-align:justify;'>
                                    <span style="font-size:16px;">TIN No.&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp; &nbsp;
                                        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;:
                                        &nbsp;<?php echo e($reservation->client->tin_no); ?></span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;margin-left:36.0pt;text-align:justify;'>
                                    <span style="font-size:16px;">Passport No.&nbsp; &nbsp;
                                        &nbsp; &nbsp;
                                        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;:
                                        &nbsp;<?php echo e($reservation->client->passport_no); ?></span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;margin-left:36.0pt;text-align:justify;'>
                                    <span style="font-size:16px;">Passport Validity&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                        &nbsp;:
                                        &nbsp;<?php echo e(Carbon\Carbon::parse($reservation->client->passport_validity)->format('F
                                        d, Y')); ?></span>
                                </p>
                                ...
                                <p
                                    ...
                                    <span style="font-size:16px;">Broker&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                                        ...
                                        &nbsp;
                                        &nbsp; &nbsp; &nbsp;
                                        &nbsp;&nbsp;:&nbsp;&nbsp;<?php echo e($reservation->client->agent->broker->name); ?></span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;margin-left:36.0pt;text-align:justify;'>
                                    <span style="font-size:16px;">Contact No.: &nbsp; &nbsp; &nbsp;
                                        &nbsp;
                                        &nbsp; &nbsp; &nbsp;
                                        &nbsp;&nbsp;:&nbsp;&nbsp;<?php echo e($reservation->client->agent->broker->contact_no); ?></span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;margin-left:36.0pt;text-align:justify;'>
                                    <span style="font-size:16px;">Agent&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                                        ...
                                        &nbsp;
                                        &nbsp; &nbsp; &nbsp;
                                        &nbsp;&nbsp;:&nbsp;&nbsp;<?php echo e($reservation->client->agent->name); ?></span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;margin-left:36.0pt;text-align:justify;'>
                                    <span style="font-size:16px;">Contact No.: &nbsp; &nbsp; &nbsp;
                                        &nbsp;
                                        &nbsp; &nbsp; &nbsp;
                                        &nbsp;&nbsp;:&nbsp;&nbsp;<?php echo e($reservation->client->agent->contact); ?></span>
                                </p>
                                ...
                                <p
                                    ...
                                    <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Lot
                                        Area&nbsp;&nbsp;
                                        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;<?php echo e($reservation->property->lot_area); ?>m&#178;</span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                    <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Block
                                        No.&nbsp;
                                        &nbsp; &nbsp; &nbsp; &nbsp;:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;<?php echo e($reservation->property->blk_no); ?></span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                    <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Lot
                                        No.&nbsp;
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;<?php echo e($reservation->property->lot_no); ?></span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                    <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Title
                                        No.&nbsp;
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;<?php echo e($reservation->property->title_no); ?></span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                    <span style="font-size:16px;">&nbsp;</span>
                                ...
                                <p
                                    ...
                                    <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        ...
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;:&nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;
                                        &nbsp;<?php echo e($reservation->property->model); ?></span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                    <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Floor
                                        Area&nbsp;
                                        &nbsp; &nbsp; &nbsp;:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;<?php echo e($reservation->property->floor_area); ?>m&#178;</span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                    <span style="font-size:16px;">&nbsp;</span>
                                ...
                                <p
                                    ...
                                    <span style="font-size:16px;">Reservation Fee&nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;&nbsp;:
                                        &nbsp;
                                        <strong>&#8369; <?php echo e(number_format($reservation->downpayment, 2)); ?></strong>
                                        &nbsp; &nbsp; &nbsp; &nbsp;Holding Date from:&nbsp;
                                        <strong><?php echo e(Carbon\Carbon::parse($reservation->created_at)->format('F m,
                                            Y')); ?></strong> &nbsp;to:&nbsp;
                                        <strong><?php echo e(Carbon\Carbon::parse($reservation->upholding_date)->format('F m,
                                            Y')); ?> </strong></span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;margin-left:36.0pt;text-align:justify;'>
                                    <span style="font-size:16px;">Contract Price &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        ...
                                        <strong>Php <?php echo e(number_format($reservation->property->total_contract_price,2)); ?>
                                ...
                                <p
                                    ...
                                    <span style="font-size:16px;">40% Down payment &nbsp; :
                                        <strong>
                                            &#8369; <?php echo e(number_format($reservation->property()->first()->downpayment_total,2)); ?>

                                        </strong>
                                        &nbsp;Due Date:&nbsp;
                                        <strong>
                                            <?php echo e(Carbon\Carbon::parse($reservation->paymentSchedules()->where('payment_for', 'Downpayment Scheme')->orderByDesc('id')->first()->payment_date)->format('F
                                            d, Y')); ?>
                                ...
                                <ul style="list-style-type: disc;margin-left:44px;">
                                    <li><span style="font-size:16px;">Spot Cash
                                            ...
                                            <strong>
                                                Php <?php echo e($reservation->property->downpayment_term == 1?
                                                number_format($reservation->paymentSchedules->first()->downpayment_scheme_monthly_payment,
                                                2) : '___________'); ?>
                                    ...
                                    <li><span style="font-size:16px;">Six (6) months to pay @
                                            <strong>
                                                &#8369; <?php echo e($reservation->property->downpayment_term == 6 ?
                                                number_format($reservation->paymentSchedules->first()->downpayment_scheme_monthly_payment,
                                            ...
                                            <strong>
                                                <?php echo e($reservation->property->downpayment_term == 6 ?
                                                Carbon\Carbon::parse($reservation->paymentSchedules->first()->downpayment_scheme_start_payment)->format('F
                                                d, Y') : '____________'); ?>
                                            ...
                                            <strong>
                                                <?php echo e($reservation->property->downpayment_term == 6 ?
                                                Carbon\Carbon::parse($reservation->paymentSchedules->first()->downpayment_scheme_end_payment)->format('F
                                                d, Y') : '_____________________'); ?>

                                            </strong>.
                                        </span></li>
                                    <li><span style="font-size:16px;">Twelve (12) months to pay @
                                            <strong>
                                                &#8369; <?php echo e($reservation->property->downpayment_term == 12 ?
                                                number_format($reservation->paymentSchedules->first()->downpayment_scheme_monthly_payment,
                                                2) : '________________'); ?>/mo.
                                            </strong>
                                            Starting
                                ...
                                <p
                                    ...
                                    <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;60%
                                        Balance &nbsp;:
                                        <strong>
                                            &#8369; <?php echo e(number_format($reservation->property()->first()->balance_total,2)); ?>

                                        </strong>
                                        &nbsp;Due Date:&nbsp;
                                        <strong>
                                            <?php echo e(Carbon\Carbon::parse($reservation->paymentSchedules()->where('payment_for', 'Balance Scheme')->orderByDesc('id')->first()->payment_date)->format('F
                                            d, Y')); ?>
                                ...
                                <ul style="list-style-type: disc;margin-left:44px;">
                                    <li><span style="font-size:16px;">Spot Cash
                                            ___________________________________________(
                                            <strong>
                                                Php <?php echo e($reservation->property->balance_term == 1?
                                                number_format($reservation->paymentSchedules->first()->balance_scheme_monthly_payment,
                                                2) : '___________'); ?>
                                    ...
                                    <li><span style="font-size:16px;">Six (6) months to pay @
                                            <strong>
                                                &#8369; <?php echo e($reservation->property->balance_term == 6 ?
                                                number_format($reservation->paymentSchedules->first()->balance_scheme_monthly_payment,
                                                2) : '________________'); ?>/mo.
                                            </strong>
                                            Starting
                                            ...
                                            <strong>
                                                <?php echo e($reservation->property->balance_term == 6 ?
                                                Carbon\Carbon::parse($reservation->paymentSchedules->first()->balance_scheme_end_payment)->format('F
                                                d, Y') : '_____________________'); ?>
                                    ...
                                    <li><span style="font-size:16px;">Twelve (12) months to pay with 10% interest @
                                            <strong>
                                                &#8369; <?php echo e($reservation->property->balance_term == 12 ?
                                                number_format($reservation->paymentSchedules->first()->balance_scheme_monthly_payment,
                                                2) : '________________'); ?>/mo.
                                            </strong>
                                            Starting
                                    ...
                                    <ol style="margin-bottom:0cm;list-style-type: decimal;margin-left:44px;">
                                        ...
                                        <li
                                            ...
                                            <span style="font-size:16px;">The house construction shall start immediately
                                                ...
                                                on
                                                <strong>
                                                    <?php echo e(Carbon\Carbon::parse($reservation->paymentSchedules->first()->balance_scheme_start_payment)->format('F
                                                    d, Y')); ?>

                                                </strong>
                                                thereafter on every <strong>
                                                    <?php echo e(Carbon\Carbon::parse($reservation->paymentSchedules->first()->balance_scheme_start_payment)->format('jS')); ?>
                                ...
                                <p
                                    ...
                                    <span> <strong><?php echo e(Carbon\Carbon::parse(Carbon\Carbon::now())->format('F d,
                                            Y')); ?></strong> Davao City,
                                        Philippines.</span>
                                </p>
                                <p
...
</html><?php /**PATH C:\laragon\www\Infinit\maria-homes\resources\views/admin/reservations/print.blade.php ENDPATH**/ ?>