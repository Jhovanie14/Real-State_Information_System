                            ...
                            <div class="card-header">
                                <div class="d-flex">
                                    <div class="col-xl-4 col-lg-6 col-md-6 mr-2">
                                        <form action="/reservations/hdmf-loan" method="GET">
                                    ...
                                    <div class="col-md-4">
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="/reservations/hdmf-loan">All</a>
                                                <a class="dropdown-item" href="/reservations/hdmf-loan/active">Active</a>
                                                <a class="dropdown-item" href="/reservations/hdmf-loan/finished">Finished</a>
                                                <a class="dropdown-item" href="/reservations/hdmf-loan/cancelled">Cancelled</a>
                                                <a class="dropdown-item" href="/reservations/hdmf-loan/deleted">Deleted</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="d-md-flex justify-content-between">
                                        ...
                                        <div class="d-flex flex-md-column justify-content-center align-items-center py-3"
                                            style="width: 20%;">
                                            <a href="/reservations/hdmf-loan/<?php echo e($reservation->id); ?>"
                                            ...
                                            <?php endif; ?>
                                            <?php if($reservation->reservation == 1 || $reservation->reservation == 0): ?>
                                                <a href="#" data-toggle="modal"
...
<?php echo $__env->make('layouts.themes.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Infinit\maria-homes\resources\views/admin/reservations/hdmf-loan/index.blade.php ENDPATH**/ ?>