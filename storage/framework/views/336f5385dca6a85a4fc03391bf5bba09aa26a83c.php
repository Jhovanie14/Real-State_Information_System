    ...
    <div class="container">
        <div class="wrapper">
            ...
            <p
                ...
                <b><?php echo e(\Carbon\Carbon::parse(\Carbon\Carbon::now())->format('jS')); ?></b> day of
                <b><?php echo e(\Carbon\Carbon::parse(\Carbon\Carbon::now())->format('F')); ?></b>,
                <b><?php echo e(\Carbon\Carbon::parse(\Carbon\Carbon::now())->format('Y')); ?></b> in Davao
            ...
            <p
                style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:0cm;font-size:11.0pt;font-family:"Calibri",sans-serif;text-align:justify;'>
                <b><u><?php echo e($broker->name); ?></u></b>, of legal age, Filipino, single / married, with residential address
                at <b><u><?php echo e($broker->address); ?></u></b>, a Licensed Real Estate Broker with PRC License
                No. <b><u><?php echo e($broker->prc_license); ?></u></b>, hereinafter referred to as the <strong>&quot;ACCREDITED
                    BROKER&quot;</strong>;
            </p>
            <p
                style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:0cm;font-size:11.0pt;font-family:"Calibri",sans-serif;text-align:center;'>
            ...
            <div class="d-flex justify-content-center mb-5 pb-5">
                ...
                <div class="d-flex flex-column align-items-center mx-5">
                    <p style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                        <span style="font-size:16px;" class="text-bold "><u><?php echo e($broker->name); ?></u></span>
                    </p>
                    <p style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
            ...
            <p style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp;&nbsp;<strong>BEFORE
                        ME</strong>, this <b><?php echo e(\Carbon\Carbon::parse(\Carbon\Carbon::now())->format('jS')); ?></b> day
                    of <b><?php echo e(\Carbon\Carbon::parse(\Carbon\Carbon::now())->format('F')); ?></b>,
                    <b><?php echo e(\Carbon\Carbon::parse(\Carbon\Carbon::now())->format('Y')); ?></b>, personally appeared the
                    following:</span>
            </p>
            <br>
            ...
            <div class="d-flex justify-content-between">
                <p><?php echo e($broker->name); ?></p>
                <p><?php echo e($broker->prc_license); ?></p>
                <p><?php echo e(Carbon\Carbon::now()->format('F d, Y')); ?></p>
            </div>
...
<?php /**PATH C:\laragon\www\Infinit\maria-homes\resources\views/admin/brokers/print.blade.php ENDPATH**/ ?>