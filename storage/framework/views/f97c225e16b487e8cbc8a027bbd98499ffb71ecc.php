                                        ...
                                        <div class="active tab-pane" id="propertyInfo">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7 px-3">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <?php if($property->active != 0 && ($property->status != 3 || $property->status != 0)): ?>
                                            ...
                                            <div class="d-flex justify-content-end align-items-center mx-3">
                                                <a class="btn btn-primary ml-3 px-3"
                                                    href="/properties/hdmf-loan/<?php echo e($property->id); ?>/print-payment-schedule">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-hover table-bordered table-lg ">
                                                            ...
                                                            <tbody>
                                                                <?php $__currentLoopData = $property->hdmfLoanPaymentSchedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr class="text-bold">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-hover table-bordered table-lg">
                                                            ...
                                                            <tbody>
                                                                <?php $__currentLoopData = $property->hdmfLoanPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr class="text-bold">
                                                                        <td class="text-bold h6 text-center">
                                                                            <?php echo e($loop->iteration); ?>
                ...
                <div class="modal-header bg-primary">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <form action="/properties/hdmf-loan/<?php echo e($property->id); ?>/set-fully-paid" method="POST">
                            ...
                            <form action="/properties/hdmf-loan/<?php echo e($property->id); ?>/set-equity-balance" method="POST">
                                <?php echo method_field('PATCH'); ?>
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn btn-lg btn-primary w-100 mb-2">
    ...
    <div class="modal fade" id="clientsModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="/properties/hdmf-loan/<?php echo e($property->id); ?>/assume" method="POST">
                    <?php echo method_field('PATCH'); ?>
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="container-fluid">
    ...
    <div class="modal fade" id="addPaymentModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <form action="/properties/hdmf-loan/<?php echo e($property->id); ?>/payment" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="col-sm-12">
...
<?php echo $__env->make('layouts.themes.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Infinit\maria-homes\resources\views/admin/properties/hdmf-loan/show.blade.php ENDPATH**/ ?>