                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="d-flex flex-column justify-content-center align-items-center"
                                    style="width: 15%;">
                                    <a href="/agents/{{ $agent->id }}" class="btn btn-block btn-primary btn-block">
                                    ...
                                    @if($agent->active == 1)
                                    <a href="#" data-toggle="modal" data-target="#confirmDelete{{$agent->id}}"
...
{{-- <div class="modal fade" id="optionsModal{{$agent->id}}" tabindex="-1" role="dialog">
...
<div class="modal fade" id="confirmDelete{{$agent->id}}" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="/brokers/{{$agent->id}}/delete" method="POST">
                    @csrf
                    @method('PATCH')
...
<div class="modal fade" id="confirmArchive{{$agent->id}}" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="/brokers/{{$agent->id}}/archive" method="POST">
                    @csrf
                    @method('PATCH')
...
<div class="modal fade" id="confirmUnarchive{{$agent->id}}" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="/brokers/{{$agent->id}}/activate" method="POST">
                    @csrf
                    @method('PATCH')
