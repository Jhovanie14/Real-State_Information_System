                                ...
                                <div>
                                    ...
                                    <div class="timeline-item">
                                        <span class="time"><i class="fas fa-clock"></i> {{
                                            \Carbon\Carbon::parse($news_item->nws_date_created)->diffForHumans()
                                            }}</span>
                                        ...
                                        <div class="timeline-body">
                                            ...
                                            <div class="thumbnail">
                                                <a href="{{ asset('images/news/' . $news_item->nws_image) }}">
                                                    <img src="{{ asset('images/news/' . $news_item->nws_image) }}"
                                                        alt="" style="width:100%">
                                                </a>
                                                <div class="caption">
                                        ...
                                        <div class="timeline-footer">
                                            ...
                                            {{-- <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#removeNews-{{$news_item->nws_id}}"><i
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <a class="btn btn-danger btn-sm"
                                                        href="{{ action('NewsController@delete',[$news_item->nws_id]) }}"><i
                            ...
                            <ul class="products-list product-list-in-card pl-2 pr-2">
                                ...
                                <li class="item">
                                    <div class="product-img">
                                        <img class="img-size-50 img-circle" src="{{ asset(get_avatar($log->emp_id)) }}"
                                            alt="logs user image">
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="nws_title" name="nws_title"
                                    placeholder="Title" value="{{ old('nws_title') }}" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control" id="nws_content" name="nws_content"
                                    rows="4">{{ old('nws_content') }}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="nws_image" name="nws_image"
                                        value="{{ old('nws_image') }}" aria-describedby="inputGroupFileAddon01">
