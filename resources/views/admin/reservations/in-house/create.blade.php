    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark ">In-House Payment Reservation</h1>
                    </div>
                    <div class="col-sm-6 ">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">In-House Payment</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                <form action="/reservations/in-house" method="POST" enctype="multipart/form-data">
                    @csrf
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <label for="installment" class="form-label"
                                                            id="downpayment-text">Downpayment Scheme
                                                            Payment:</label>
                                            ...
                                            <div class="d-sm-flex">
                                                <div class="col-sm-12">
                                                    <div class="form-group" id="balance-scheme">
                                                        ...
                                                        <select class="form-control form-control-lg" name="balanceTerm"
                                                            id="balance-select" required>
                                                            <option value="" selected disabled hidden>Choose...
                                                            </option>
                                                            <option value="1">Spot Cash
                                                            </option>
