            ...
            <div class="wrapper">
                <section class="invoice">
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <img class="roundedSmallImage border" src="{{ asset('/storage/icons/mariahomes.png') }}" alt="">
                    </div>
                            ...
                            <div>
                                ...
                                <p
                                    ...
                                    <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Lot
                                        Area&nbsp;&nbsp;
                                        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;{{$reservation->property->lot_area}}m&#178;</span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                    <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Block
                                        No.&nbsp;
                                        &nbsp; &nbsp; &nbsp; &nbsp;:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;{{$reservation->property->blk_no}}</span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                    <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Lot
                                        No.&nbsp;
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;{{$reservation->property->lot_no}}</span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                    <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Title
                                        No.&nbsp;
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;{{$reservation->property->title_no}}</span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                    <span style="font-size:16px;">&nbsp;</span>
                                ...
                                <p
                                    ...
                                    <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        ...
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;:&nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;
                                        &nbsp;{{$reservation->property->model}}</span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                    <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Floor
                                        Area&nbsp;
                                        &nbsp; &nbsp; &nbsp;:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;{{$reservation->property->floor_area}}m&#178;</span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>
                                    <span style="font-size:16px;">&nbsp;</span>
                                ...
                                <p
                                    ...
                                    <span style="font-size:16px;">Reservation Fee&nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;&nbsp;:
                                        &nbsp;
                                        <strong>&#8369; {{number_format($reservation->downpayment, 2)}}</strong>
                                        &nbsp; &nbsp; &nbsp; &nbsp;Holding Date from:&nbsp;
                                        <strong>{{Carbon\Carbon::parse($reservation->created_at)->format('F m,
                                            Y')}}</strong> &nbsp;to:&nbsp;
                                        <strong>{{Carbon\Carbon::parse($reservation->upholding_date)->format('F m,
                                            Y')}} </strong></span>
                                </p>
                                <p
                                    style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;margin-left:36.0pt;text-align:justify;'>
                                    <span style="font-size:16px;">Contract Price &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        ...
                                        <strong>Php {{number_format($reservation->property->total_contract_price,2)}}
                                        </strong>
                                ...
                                <p
                                    ...
                                    <span style="font-size:16px;">40% Down payment &nbsp; :
                                        <strong>
                                            &#8369; {{
                                            number_format($reservation->property()->first()->downpayment_total,2)}}
                                        </strong>
                                        &nbsp;Due Date:&nbsp;
                                        <strong>
                                            {{Carbon\Carbon::parse($reservation->paymentSchedules()->where('payment_for', 'Downpayment Scheme')->orderByDesc('id')->first()->payment_date)->format('F
                                            d, Y')}}
                                        </strong>
                                    </span>
                                </p>
                                ...
                                <ul style="list-style-type: disc;margin-left:44px;">
                                    <li><span style="font-size:16px;">Spot Cash
                                            ...
                                            <strong>
                                                Php {{ $reservation->property->downpayment_term == 1?
                                    ...
                                    <li><span style="font-size:16px;">Six (6) months to pay @
                                            <strong>
                                                &#8369; {{
                                                $reservation->property->downpayment_term == 6 ?
                                                number_format($reservation->paymentSchedules->first()->downpayment_scheme_monthly_payment,
                                    ...
                                    <li><span style="font-size:16px;">Twelve (12) months to pay @
                                            <strong>
                                                &#8369; {{
                                                $reservation->property->downpayment_term == 12 ?
                                                number_format($reservation->paymentSchedules->first()->downpayment_scheme_monthly_payment,
                                                2) : '________________' }}/mo.
                                            </strong>
                                            Starting
                                ...
                                <p
                                    ...
                                    <span style="font-size:16px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;60%
                                        ...
                                        <strong>
                                            &#8369; {{
                                            number_format($reservation->property()->first()->balance_total,2)}}
                                        </strong>
                                        &nbsp;Due Date:&nbsp;
                                        <strong>
                                            {{Carbon\Carbon::parse($reservation->paymentSchedules()->where('payment_for', 'Balance Scheme')->orderByDesc('id')->first()->payment_date)->format('F
                                            d, Y')}}
                                        </strong></span>
                                </p>
                                <p
                                ...
                                <ul style="list-style-type: disc;margin-left:44px;">
                                    <li><span style="font-size:16px;">Spot Cash
                                            ___________________________________________(
                                            <strong>
                                                Php {{ $reservation->property->balance_term == 1?
                                    ...
                                    <li><span style="font-size:16px;">Six (6) months to pay @
                                            <strong>
                                                &#8369; {{
                                                $reservation->property->balance_term == 6 ?
                                                number_format($reservation->paymentSchedules->first()->balance_scheme_monthly_payment,
                                                2) : '________________' }}/mo.
                                            </strong>
                                            Starting
                                    ...
                                    <li><span style="font-size:16px;">Twelve (12) months to pay with 10% interest @
                                            <strong>
                                                &#8369; {{
                                                $reservation->property->balance_term == 12 ?
                                                number_format($reservation->paymentSchedules->first()->balance_scheme_monthly_payment,
                                                2) : '________________' }}/mo.
                                            </strong>
                                            Starting
                                    ...
                                    {{-- <li><span style="font-size:16px;">Eighteen (18) months to pay with 14% interest
                                            @
                                            P________________/mo. Starting____________ with Post-dated Checks (PDC) duly
                                            issued
                                            to cover the following installments up to _____________________</span></li>
                                    <li><span style="font-size:16px;">Twenty Four (24) months to pay with 18% interest @
                                            P_______________/mo. Starting _________________ with Post-dated Checks (PDC)
                                            duly
                                            issued to cover the following installments up to
                                            ______________________.</span></li>
                                ...
                                <p
                                    ...
                                    <span> <strong>{{Carbon\Carbon::parse(Carbon\Carbon::now())->format('F d,
                                            Y')}}</strong> Davao City,
                                        Philippines.</span>
                                </p>
                                <p
