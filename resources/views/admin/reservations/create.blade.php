...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark ">Place Reservation</h1>
                </div>
                <div class="col-sm-6 ">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">Place Reservation</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 pr-1 d-flex flex-column justify-content-start ">
                                        <div class="d-flex flex-column text-md-left text-center ">
                                            <div class="text-center">
                                                <img src="{{  asset('/images/housemodels/delfina/maria_delfina.png') }}"
                                    ...
                                    <div class="col-md-7 pt-2 pl-2 d-flex flex-column justify-content-between ">
                                        ...
                                        <div class="d-sm-flex">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-control-lg" name="contract"
                                                        id="contract" required>
                                                        <option value="" selected disabled hidden>Choose...</option>
                                                        <option value="In-house Payment">In-house Payment</option>
                                                        {{-- <option value="Spot Cash">Spot
                                                            Cash
                                                        </option> --}}
                                                        <option value="HDMF Loan">HDMF Loan
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-sm-flex">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="installment" class="form-label" id="downpayment-text">Downpayment Scheme
                                                        Payment:</label>

                                                    <select id="downpayment-scheme" class="form-control form-control-lg"
                                                        name="downpaymentTerm" required>
                                                        <option value="" selected disabled hidden>Choose...</option>
                                                        ...
                                                        <option value="12" hidden>18 Months
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-sm-flex">
                                            <div class="col-sm-12">
                                                <div class="form-group" id="balance-scheme">
                                                    <label for="installment" class="form-label">Balance Scheme
                                                        Payment:</label>

                                                    <select class="form-control form-control-lg" name="balanceTerm" id="balance-select"
                                                        required>
                                                        <option value="" selected disabled hidden>Choose...</option>
                                                        <option value="1">Spot Cash
                                                        </option>
                                        ...
                                        <div class="d-sm-flex">
                                            <div class="col-sm-12">
                                                <div class="form-group" id="loanable-amount" style="display: none;">
                                        ...
                                        <div class="d-sm-flex">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="downpayment" class="form-label">Reservation Fee:</label>
                                                    <input type="text" class="form-control form-control-lg border"
                                        ...
                                        <div class="d-sm-flex justify-content-between align-items-end mt-3">
                                            {{-- <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="equityFee" class="form-label">Equity
                                                        Fee:</label>
                                                    <input type="text" class="form-control form-control-lg border"
                                                        id="equityFee" name="equityFee" required>
                                                </div>
                                            </div> --}}
                                            <div class="col-sm-4">
                                                <div class="form-group">
...
<script>
    ...
    imageSelect.addEventListener("change", function() {
        ...
        // selectedImage.src = "{{ asset('images/housemodels')}}/" + imageSelect.value;
    ...
    // FOR PAYMENT-TERM
    // const paymentTermSelect = document.getElementById("payment-term-select");
    // const installmentSelect = document.getElementById("installment-select");
    // const loanableAmount = document.getElementById("loanable-amount");

    // paymentTermSelect.addEventListener("change", function() {
    //     const selectedIndex = paymentTermSelect.selectedIndex;
    //     if(selectedIndex === 1){
    //         installmentSelect.style.display = "block";
    //         loanableAmount.style.display = "none";
    //     } else if( selectedIndex === 2){
    //         installmentSelect.style.display = "block";
    //         loanableAmount.style.display = "block";
    //     } else {
    //         loanableAmount.style.display = "none";
    //         installmentSelect.style.display ="none";
    //         document.getElementById('installment').value = 'null';
    //     }
    // });

    const contract = document.getElementById("contract");
    const downpaymentScheme = document.getElementById("downpayment-scheme")
    const loanableAmount = document.getElementById("loanable-amount");
    const balanceScheme = document.getElementById("balance-scheme");
    const balanceSelect = document.getElementById("balance-select");
    const downpaymentText = document.getElementById("downpayment-text")

    contract.addEventListener("change", function(){
        const selectedIndex = contract.selectedIndex;
        if(selectedIndex === 2){
            console.log("changed");
            loanableAmount.style.display ="block";
            balanceScheme.style.display ="none"
            balanceSelect.removeAttribute("required")
            downpaymentText.textContent = "Equity"
            addOption()
        }else {
            balanceScheme.style.display ="block"
            loanableAmount.style.display ="none";
            balanceSelect.setAttribute("required", "true")
            downpaymentText.textContent = "Downpayment Scheme"
            downpaymentScheme.remove(4)
        }
    })
    ...
    function addOption () {
        ...
        option.value = "18"
        option.text = "18 Months"
        downpaymentScheme.add(option)
    }
