            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex align-items-center">
                        ...
                        <a class="btn btn-primary ml-3" target="_blank" href="/reservations/{{ $reservation->id }}/print">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    @if ($reservation->status == 2)
                                                        <a href="/properties/{{ $reservation->id }}"
                                                ...
                                                <div class="col-md-12">
                                                    <div>
                                                        ...
                                                        <span class="px-2 py-1 h5 rounded bg-success">
                                                            {{ \Carbon\Carbon::parse(\Carbon\Carbon::now())->format('F, d, Y') .
                                                                ' - ' .
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/reservations/{{ $reservation->id }}/finish" method="POST">
                        @csrf
                        @method('PATCH')
