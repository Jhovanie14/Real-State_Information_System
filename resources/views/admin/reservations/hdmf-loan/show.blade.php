            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex align-items-center">
                        ...
                        <a class="btn btn-primary ml-3" target="_blank" href="/reservations/hdmf-loan/{{ $reservation->id }}/print">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    @if ($reservation->reservation == 2)
                                                        <a href="/properties/hdmf-loan/{{ $reservation->id }}"
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="px-2 py-1 h5 rounded bg-primary">
                                                            @if ($reservation->equity_term == 1)
                                                                Spot Cash
                                                            @else
                                                                {{ $reservation->equity_term ?? '' }} Months
                                                            @endif
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                @if ($reservation->loanable_amount)
                                                    <div class="col-md-12 mt-2">
                                                        ...
                                                        <input type="text" disabled name="loanableAmount"
                                                            class="form-control form-control-lg text-lg"
                                                            value="&#8369; {{ number_format($reservation->loanable_amount, 2) ?? '' }}">
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="d-md-flex justify-content-between align-items-end mt-2">
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    ...
                                                    <input type="text" disabled name="processingFee"
                                                        class="form-control form-control-lg text-lg"
                                                        value="&#8369; {{ number_format($reservation->equity_total, 2) ?? '' }}">
                                                </div>
                                                <div class="col-md-6 mt-2">
                                                    ...
                                                    <input type="text" disabled name="cornerLotFee"
                                                        class="form-control form-control-lg text-lg"
                                                        value="&#8369; {{ number_format($reservation->equity_total / $reservation->equity_term, 2) ?? '' }}">
                                                </div>
                                            </div>
                                            {{-- <div class="d-md-flex justify-content-between align-items-end mt-2">
                                                <div class="col-md-3 mt-2">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/reservations/hdmf-loan/{{ $reservation->id }}/finish" method="POST">
                        @csrf
                        @method('PATCH')
    ...
    <div class="modal fade" id="cancelReservation" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/reservations/hdmf-loan/{{ $reservation->id }}/cancel" method="POST">
                        @csrf
                        @method('PATCH')
    ...
    <div class="modal fade" id="restoreReservation" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/reservations/hdmf-loan/{{ $reservation->id }}/restore" method="POST">
                        @csrf
                        @method('PATCH')
    ...
    <div class="modal fade" id="deleteReservation" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/reservations/hdmf-loan/{{ $reservation->id }}/delete" method="POST">
                        @csrf
                        @method('PATCH')
