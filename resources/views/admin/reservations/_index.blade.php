                        ...
                        <div class="card-body">
                            <div class="d-md-flex justify-content-between">
                                <div class="d-flex">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <img src="{{ ($reservation->model == 'Maria Delfina') ?
                                            asset('/images/housemodels/delfina/maria_delfina.png') : ( ($reservation->model ==
                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <span class="mb-0 h6 ml-2">
                                                    Blk. No: {{ $reservations ? $reservation->property->blk_no : ''}}
                                                </span>
                                            </div>
                                            <div>
                                                <i class="fa-solid fa-location-dot"></i>
                                                <span class="my-0 h6 ml-2">
                                                    Lot No: {{ $reservations ? $reservation->property->lot_no : ''}}
                                                </span>
                                            </div>
                                            <div>
                                                <i class="fa-solid fa-id-badge"></i>
                                                <span class="mt-0 h6 ml-2">
                                                    House Title: {{ $reservations ? $reservation->property->title_no :
                                                    ''}}
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="d-flex flex-md-column justify-content-center align-items-center py-3"
                                    style="width: 20%;">
                                    <a href="/reservations/{{ $reservation->id }}" class="btn btn-block btn-primary">
                                        <i class="fa-solid fa-eye"></i>
                                        <span class="d-none d-md-inline">&nbsp;View</span>
                                    </a>

                                    @if($reservation->status == 3)
                                    <a href="#" data-toggle="modal" data-target="#confirmCancel{{$reservation->id}}"
                                        class="btn btn-block btn-warning ">
                                        <i class="fa-solid fa-x"></i>
                                        <span class="d-none d-md-inline">&nbsp;Cancel</span>
                                    </a>
                                    @elseif($reservation->status == 1)
                                    <a href="#" data-toggle="modal" data-target="#confirmRestore{{$reservation->id}}"
                                    ...
                                    @endif
                                    @if($reservation->status == 3 || $reservation->status == 1)
                                    <a href="#" data-toggle="modal" data-target="#confirmDelete{{$reservation->id}}"
                            ...
                            <div class="d-md-flex">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="d-lg-flex justify-content-start">
                                        <div class="col-lg-12">
                                            <a href="/agents/{{ $reservation->client->agent->id}}" class="text-dark">
                                                <div class="card border border-gray shadow h-100 my-auto">
                                                    <div class="card-body">
                                                        <div class="d-flex justify-content-start">
                                                            <div class="mr-4 my-auto align-items-center">
