                                ...
                                <div class="col-md-4">
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="/properties/index">All</a>
                                            <a class="dropdown-item" href="/properties/active">Active</a>
                                            <a class="dropdown-item" href="/properties/finished">Finished</a>
                                            <a class="dropdown-item" href="/properties/cancelled">Cancelled</a>
                                            <a class="dropdown-item" href="/properties/deleted">Deleted</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="d-md-flex justify-content-between">
                                <div class="d-flex">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <img src="{{ ($property->model == 'Maria Delfina') ?
                                            asset('/images/housemodels/delfina/maria_delfina.png') : ( ($property->model ==
                                        'Maria Lorenza') ? asset('/images/housemodels/lorenza/maria_lorenza.png') :
                                ...
                                <div class="d-flex flex-md-column align-items-center py-3" style="width: 20%;">
                                    <a href="/properties/{{ $property->id }}" class="btn btn-block btn-primary">
                                    ...
                                    {{-- @elseif($property->status == 1)
                                    <a href="#" data-toggle="modal" data-target="#confirmRestore{{$property->id}}"
                                        class="btn btn-block btn-success ">
                                    ...
                                    @endif
                                    @if($property->status == 3 || $property->status == 1)
                                    <a href="#" data-toggle="modal" data-target="#confirmDelete{{$property->id}}"
                            ...
                            <div class="d-md-flex">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="d-lg-flex justify-content-start">
                                        <div class="col-lg-12">
                                            <a href="/brokers/{{ $property->client->agent->broker->id}}" class="text-dark">
                                                <div class="card border border-gray shadow h-100 my-auto">
                                                    <div class="card-body">
                                                        <div class="d-flex justify-content-start">
                                                            <div class="mr-4 my-auto align-items-center">
...
@foreach($properties as $property)
<div class="modal fade" id="confirmArchive{{$property->ppt_id}}" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="/properties/{{$property->ppt_id}}/archive" method="POST">
                    @csrf
                    @method('PATCH')
...
<div class="modal fade" id="confirmDelete{{$property->ppt_id}}" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="/properties/{{$property->ppt_id}}/delete" method="POST">
                    @csrf
                    @method('PATCH')
...
<div class="modal fade" id="confirmActivate{{$property->ppt_id}}" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h5 class="modal-title">Confirm Reactivate</h5>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-footer">
                <form action="/properties/{{ $property->ppt_id}}/activate" method="POST">
                    @csrf
                    @method('PATCH')
