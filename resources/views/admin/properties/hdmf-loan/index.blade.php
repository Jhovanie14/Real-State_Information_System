                                ...
                                <div class="card-body">
                                    <div class="d-md-flex justify-content-between">
                                        ...
                                        <div class="d-flex flex-md-column align-items-center py-3" style="width: 20%;">
                                            <a href="/properties/hdmf-loan/{{ $property->id }}"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form action="/properties/hdmf-loan/{{ $property->id }}/cancel" method="POST">
                            @csrf
                            @method('PATCH')
        ...
        <div class="modal fade" id="confirmDelete{{ $property->id }}" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form action="/properties/hdmf-loan/{{ $property->id }}/delete" method="POST">
                            @csrf
                            @method('PATCH')
        ...
        <div class="modal fade" id="confirmRestore{{ $property->id }}" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form action="/properties/hdmf-loan/{{ $property->id }}/restore" method="POST">
                            @csrf
                            @method('PATCH')
