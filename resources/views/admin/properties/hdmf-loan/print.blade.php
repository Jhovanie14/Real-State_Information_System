        ...
        <div class="mb-2">
            ...
            <div class="d-flex justify-content-start align-items-start ">
                ...
                <div class="col d-flex justify-content-between">
                    ...
                    <label class="my-0">
                        {{ $property->client->first_name ?? null }}
                        {{ $property->client->last_name ?? null }}
                    </label>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-start align-items-start ">
                <div class="col d-flex justify-content-between">
                    ...
                    <label class="my-0">
                        Blk {{ $property->blk_no ?? null }}
                    </label>
                </div>
                <div class="col d-flex justify-content-between">
                    <label class="control-label mr-5 my-0">Address:</label>
                    <label class="my-0">
                        {{ $property->client->present_address ?? null }}
                    </label>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-start align-items-start ">
                <div class="col d-flex justify-content-between">
                    ...
                    <label class="my-0">
                        {{ $property->floor_area ?? null }}m&#178;
                    </label>
                </div>
                <div class="col d-flex justify-content-between">
                    <label class="control-label mr-5 my-0">Email:</label>
                    <label class="my-0">
                        {{ $property->client->email ?? null }}
                    </label>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-start align-items-start ">
                <div class="col d-flex justify-content-between">
                    ...
                    <label class="my-0">
                        {{ $property->title_no ?? null }}
                    </label>
                </div>
                <div class="col d-flex justify-content-between">
                    <label class="control-label mr-5 my-0">Date of Birth:</label>
                    <label class="my-0">
                        {{ Carbon\Carbon::parse($property->client->date_of_birth)->format('F d, Y') ?? '' }}
                    </label>
                </div>
            </div>
        </div>
            ...
            <table class="table table-hover table-bordered table-lg ">
                ...
                <tbody>
                    ...
                    <tr class="text-bold mt-4">
                        ...
                        <td class="text-bold h6">
                            &#8369;
                            {{ number_format($total - $remaining, 2) ?? '' }}
                        </td>
                    </tr>
                    <tr class="text-bold mt-4">
                        <td class="text-bold h6 text-center" colspan="3">
